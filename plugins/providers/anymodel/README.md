...
Optional context, description, and pricing facts come only from the authenticated catalog;
missing values stay unknown rather than being inferred from the model identifier.
